...
class LLMHistory():
    def __init__(self, etcdClient: EtcdClient):
        self.etcd_client = etcdClient
        self.chat_history_prefix = "/tqms/chatHistory"
    ...
    def load_consistence_data(self) -> Dict[str, dict]:
        try:
            if not os.path.exists(self.prompt_file_path):
                ...
                data = {
                        "qwen_default": {
                            "prompt_header": "You are a helpful assistant.",
                            "prompt_history": {
                                "input": "{input}",
                                "output": "{output}"
                            },
                        ...
                        "qwen_geo_chat": {
                            "prompt_header": "You are a helpful assistant. Follow every direction here when crafting your response: Ensure that all information is coherent and that you *synthesize* information rather than simply repeating it. Be concise and relevant.",
                            "prompt_history": {
                                "input": "{input}",
                                "output": "{output}"
                            },
                        ...
                        "qwen_geo_summary": {
                            "prompt_header": "You are an expert in geoscience. Please answer the professional [question] in the field of geoscience based on [reference]. If the reference is not relevant to the question, answer according to your own expertise.",
                            "prompt_history": {
                                "input": "{input}",
                                "output": "{output}"
                            },
...
promptServer = PromptTemplateServer(MODEL_DIR+"/prompt_template.json")
