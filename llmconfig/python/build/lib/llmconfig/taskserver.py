        ...
        try:
            if not os.path.exists(self.prompt_file_path):
                ...
                data = {
                        ...
                        "qwen_geo_chat": {
                            "templateName":"qwen_geo_chat",
                            "systemPrompt": "You are a helpful assistant. Follow every direction here when crafting your response: Ensure that all information is coherent and that you *synthesize* information rather than simply repeating it. Be concise and relevant.",
                            "query": "{input}",
                            "chatHistory": {
                                "historyInput": "{input}",
                                "historyOutput": "{output}"
                        ...
                        "qwen_geo_summary": {
                            "templateName":"qwen_geo_summary",
                            "systemPrompt": "You are an expert in geoscience. Please answer the professional [question] in the field of geoscience based on [reference]. If the reference is not relevant to the question, answer according to your own expertise.",
                            "query": "{input}",
                            "chatHistory": {
                                "historyInput": "{input}",
                                "historyOutput": "{output}"
                        ...
                        "qwen_default_question": {
                            "templateName":"qwen_default_question",
                            "systemPrompt": "You are a helpful assistant.",
                            "query": "{input}",
                            "chatHistory": {
                                "historyInput": "{input}",
